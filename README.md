...
Publish the website in the URL : http://aadheeshwar.student.saveetha.in/
## PROGRAM :
### HTML:
~~~
...
<body style="text-align: center;background-color: rgb(138, 99, 99);color:rgb(214, 200, 200);">
    <!--Hi there-->
    <h1>Volume of Cuboid</h1>
    <div style="display: block; background-color: #000000;text-align: center;border-radius: 20px;width: 800px; height: 310px; margin-left: auto; margin-right: auto;">
        <form method="POST" style="padding-top: 25px;color: rgb(238, 234, 234);">
            {% csrf_token %}
        ...
        <u> <h2 style="color: wheat;">Developed By Aadheeshwar.A</h2></u>
    </div>
</body>
</html>
~~~
